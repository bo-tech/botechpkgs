  ...
  taiga = super.buildPythonPackage rec {
    ...
    setup_py_file = pkgs.writeText "setup.py" ''
      ...
      setup(
          ...
          package_data={
              'taiga': [
                  'hooks/bitbucket/migrations/logo.png',
                  'hooks/github/migrations/logo.png',
                  'hooks/gitlab/migrations/logo-v2.png',
                  'hooks/gitlab/migrations/logo.png',
                  'hooks/gogs/migrations/logo.png',
                  '**/fixtures/*',
                  # TODO: mbld: Really?
                  '**/static/**/*',
                  '**/static/**/**/*',
